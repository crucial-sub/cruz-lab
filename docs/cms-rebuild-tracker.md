...
- `done` 출간 모달을 최종 확인과 썸네일 업로드 중심으로 정리해 메타데이터 입력 역할 중복을 줄였다.
...
- 썸네일 업로드와 최종 카드 미리보기는 아직 출간 모달 중심이다. 즉 메타데이터 편집과 최종 미리보기가 완전히 하나의 화면으로 합쳐진 상태는 아니다.
...
- 2026-03-26: 출간 모달에서 중복 메타데이터 편집 UI를 걷어내고, 최종 확인 항목과 썸네일 업로드, 로컬 백업, 출간 액션 중심으로 역할을 줄였다.
